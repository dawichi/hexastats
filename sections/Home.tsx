                            ...
                            <table className={`table-auto m-3 text-center border ${styles.foreground}`}>
                                <thead>
                                    <tr>
                                        ...
                                        <th className='py-1 px-2 bg-green-300 dark:bg-green-800'>
                                            <span>Games</span>
                                        </th>
                                        <th className='py-1 px-2 bg-purple-300 dark:bg-purple-800'>
                                            <span>KDA</span>
                                        </th>
                                        <th className='py-1 px-2 bg-red-300 dark:bg-red-800'>
                                            <span>K</span>
                                        </th>
                                        <th className='py-1 px-2 bg-zinc-400 dark:bg-zinc-400'>
                                            <span>D</span>
                                        </th>
                                        <th className='py-1 px-2 bg-pink-300 dark:bg-pink-800'>
                                            <span>A</span>
                                        </th>
                                        <th className='py-1 px-2 bg-yellow-300 dark:bg-yellow-800'>
                                            <span>CSM</span>
                                        </th>
                                    </tr>
                                </thead>
