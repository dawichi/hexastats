/**
 * ## Returns the trophy icon for the given trophy
 *
 * @param rank the position in the podium [1,2,3]
 * @returns A span. Empty or with a trophy to show
 */
export const trophyIcon = (rank: number): JSX.Element => {
    const icons = {
        1: (
